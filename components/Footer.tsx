  ...
  return (
    <footer className="bg-darkBlue 2xl:pl-36 px-6 pt-12 2xl:pt-[73px] pb-9">
      <div className="xl:flex-row   xl:flex">
        ...
        <div className="flex flex-col gap-3 sm:flex-col-reverse xl:flex-row-reverse">
          <div className="">
          ...
          <div className="flex flex-col  sm:flex-row gap-12 mt-12 xl:gap-16 sm:mt-0">
            <article>
              <h2 className="text-softBlue font-normal text-2xl mb-4">
                Company
              </h2>
      ...
      <p className="text-sm font-normal text-offWhite mt-28">
